...
import json
from corona.coronaApp import CoronaInformation
...
class LuisConnect(ActivityHandler):
    ...
    async def on_message_activity(self,turn_context:TurnContext):
        ...
        corona=corona_info.get_corona_info(json_str.get('entity'))
        self.log.write_log(sessionID='session1',log_message="Bot Says: "+str(corona))
        await turn_context.send_activity(f"{corona}")